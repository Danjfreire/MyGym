...
delimiter \\
create procedure removerAtividade(in idAtiv int)
	begin
		START TRANSACTION;
		delete from atividade where id = idativ;
		delete from plano_atividade where id_atividade = idAtiv;
		delete from faz_Atividade where id_atividade = idAtiv;
		COMMIT;
	end \\
